    ...
    >
      <div className="grid min-h-[70vh] grid-cols-1 items-center md:grid-cols-2">
        ...
        >
          ...
          <span className=" job-title block bg-gradient-to-tr from-yellow-500 via-yellow-200 to-yellow-500 bg-clip-text text-center text-2xl font-bold uppercase tracking-[.2em] text-transparent opacity-0 md:text-left md:text-4xl">
